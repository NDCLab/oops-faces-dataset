...
%
% This script was edited by Emily Martin and George Buzzell for the oops-faces study pilot (v1)
%
% ************************************************************************
...
main_dir = '/home/data/NDClab/datasets/oops-faces-dataset/code';

%% Setting up other things

%Location of MADE and ADJUSTED-ADJUST scripts
addpath(genpath([main_dir filesep 'code' filesep 'eeg' filesep 'MADE-EEG-preprocessing-pipeline']));% enter the path of the EEGLAB folder in this line
...
channel_locations = [main_dir filesep 'code' filesep 'eeg' filesep 'MADE-EEG-preprocessing-pipeline' filesep 'chan_locs_files' filesep 'GSN-HydroCel-129.sfp'];
...
stimulus_timeoffset = 5.404762; % stimulus related time offset (in milliseconds). 0 = No time offset
stimulus_timeoffset1 = 9.22619; %for second stimulus 
response_timeoffset = 0;    % response related time offset (in milliseconds). 0 = No time offset
stimulus_markers = {'13', '14'};      % enter the stimulus makers that need to be adjusted for time offset
stimulus_markers1 = {'15','16','17','18'}; %for the second stimulus
response_markers = {'11', '12', '21', '22'};       % enter the response makers that need to be adjusted for time offset
...
task_event_markers = {'13', '14', '15', '16', '17', '18', '11', '12', '21', '22'}; % enter all the event/condition markers
...
%rest_epoch_length = 3; % for resting EEG continuous data will be segmented into consecutive epochs of a specified length (here 2 second) by adding dummy events
...
for subject=1:length(datafile_names)
    ...
    %% STEP 1: Import EEG data file and relevant information
      ...
      %Import EGI data file and relevant information
...
%     EEG = pop_select( EEG,'nochannel', 65:72); % delete redundant channels
    ...
    %% STEP 3: Adjust stim/response related time offset
    ...
    newChanlocs = loadbvef('/home/data/NDClab/datasets/oops-faces-dataset/code/eeg/MADE-EEG-preprocessing-pipeline/chan_locs_files/electrode_locs_files/CACS-128-X7-FIXED-64only.bvef');
