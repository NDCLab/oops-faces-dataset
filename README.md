...
Stimuli will be created using FaReT, a recent open source toolbox to create realistic computerized face models. Click [here](https://github.com/fsotoc/FaReT) for more information.
